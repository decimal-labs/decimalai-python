...
cells = [
    ...
    code(
        ...
        "FALLBACK = {\n"
        "    # demo_case is case-04 ON PURPOSE — the case where this skill LOSES. Keep the\n"
        ...
        "    \"demo_skill\": {\"slug\": \"archive228-decision-record\",\n"
        "                   \"skill_id\": \"51f03735-9772-4550-bc59-c5089cfcb35c\",\n"
        "                   \"source_type\": \"github_import\", \"version\": 1,\n"
        "                   \"demo_case\": \"case-04\",\n"
    ...
    md(
        ...
        "`decimalai skills pull " + "archive228-decision-record" + " --out .claude/skills/` — anonymous,\n"
